<form action="{{ url('/kitab/' . $kitab->kitab_id . '/update_ajax') }}" method="POST" id="form-edit">
    @csrf
    @method('PUT')
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Data Kitab</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_kitab" value="{{ $kitab->kode_kitab }}" class="form-control" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="judul_kitab" value="{{ $kitab->judul_kitab }}" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori_id" class="form-control" required>
                                ...
                                @foreach($kategori as $k)
                                    <option value="{{ $k->kategori_id }}" {{ ($k->kategori_id == $kitab->kategori_id) ? 'selected' : '' }}>{{ $k->nama_kategori }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="pengarang_id" class="form-control" required>
                                ...
                                @foreach($pengarang as $p)
                                    <option value="{{ $p->pengarang_id }}" {{ ($p->pengarang_id == $kitab->pengarang_id) ? 'selected' : '' }}>{{ $p->nama_pengarang }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="penerbit_id" class="form-control" required>
                                ...
                                @foreach($penerbit as $p)
                                    <option value="{{ $p->penerbit_id }}" {{ ($p->penerbit_id == $kitab->penerbit_id) ? 'selected' : '' }}>{{ $p->nama_penerbit }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="supplier_id" class="form-control">
                                ...
                                @foreach($supplier as $s)
                                    <option value="{{ $s->supplier_id }}" {{ ($s->supplier_id == $kitab->supplier_id) ? 'selected' : '' }}>{{ $s->nama_supplier }}</option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="tahun_terbit" value="{{ $kitab->tahun_terbit }}" class="form-control" min="1900" max="{{ date('Y') }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="tebal_buku" value="{{ $kitab->tebal_buku }}" class="form-control" min="10">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Bahasa</label>
                            <input type="text" name="bahasa" value="{{ $kitab->bahasa }}" class="form-control">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Stok</label>
                            <input type="number" name="stok" value="{{ $kitab->stok }}" class="form-control" min="0" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="stok_minimal" value="{{ $kitab->stok_minimal }}" class="form-control" min="0" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option value="aktif" {{ ($kitab->status == 'aktif') ? 'selected' : '' }}>Aktif</option>
                                <option value="nonaktif" {{ ($kitab->status == 'nonaktif') ? 'selected' : '' }}>Nonaktif</option>
                            </select>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="harga_beli" value="{{ $kitab->harga_beli }}" class="form-control" min="0" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="harga_jual" value="{{ $kitab->harga_jual }}" class="form-control" min="0" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Diskon (%)</label>
                            <input type="number" name="diskon" value="{{ $kitab->diskon }}" class="form-control" min="0" max="100">
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" class="form-control" rows="2">{{ $kitab->deskripsi }}</textarea>
