<form action="{{ url('/santri/ajax') }}" method="POST" id="form-tambah">
    @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_santri" class="form-control" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_telepon_orang_tua" class="form-control">
