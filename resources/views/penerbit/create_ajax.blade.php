<form action="{{ url('/penerbit/ajax') }}" method="POST" id="form-tambah">
    @csrf
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data Penerbit</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="kode_penerbit" class="form-control" required>
