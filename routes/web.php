...
Route::middleware(['auth'])->group(function () {
    ...
    // ==================== SEMUA ROLE (Admin, Manager, Kasir) ====================
    
    // Data Kitab - Semua role bisa melihat dan mengelola
    ...
    // Penjualan (POS) - Semua role (Admin, Manager, Kasir)
    ...
    // Manajemen Stok - Semua role (Admin, Manager, Kasir)
    ...
    // ==================== HANYA ADMIN & MANAGER (Tidak untuk Kasir) ====================
    ...
    // ==================== HANYA ADMIN (Tidak untuk Manager & Kasir) ====================
    Route::middleware(['authorize:ADM'])->group(function () {
        ...
        Route::prefix('penerbit')->group(function () {
            ...
            Route::get('/{id}/show_ajax', [PenerbitController::class, 'show_ajax']);
